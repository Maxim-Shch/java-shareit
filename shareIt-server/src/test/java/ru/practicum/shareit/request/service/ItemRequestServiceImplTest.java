...
public class ItemRequestServiceImplTest {
    ...
    void testAddNewRequestWithWrongUser() {
        ...
        assertThrows(NotFoundException.class, () -> requestService.addNewRequest(requestDto, 100L));
    ...
    void testAddNewRequestWithIncorrectUserId() {
        when(userRepository.findById(anyLong()))
                .thenThrow(new BadRequestException("Некорректный ввод id пользователя"));
    ...
    void testGetRequestByIdWithWrongUser() {
        ...
        assertThrows(NotFoundException.class, () -> requestService.getRequestById(100L, anyLong()));
    ...
    void testGetAllRequestsForAllUsers() {
        ...
        when(requestRepository.findAll(any(PageRequest.class)))
                .thenReturn(new PageImpl<>(List.of(request, secondRequest)));

        Collection<ItemRequestDto> allRequests = requestService
    ...
    void testGetAllRequestsForAllUsersWithIncorrectUserId() {
        ...
        assertThrows(BadRequestException.class, () -> requestService
                .getAllRequestsForAllUsers(-1L, 0, 10));
